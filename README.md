...
удалять фоновый цвет с заданным размахом. Приложение поддерживает форматы
```png``` и ```jpeg```.

![Демонстрация возможностей редактора 1](pics/demo_1.png)
![Демонстрация возможностей редактора 2](pics/demo_2.png)
